...
function socketConnection(socket) {
  ...
  // socket.on("pushActionToHistory", noFail(function broadcast(msg) {
  //   broadcastHistoryAction(msg, "pushActionToHistory",socket)
  // }))

  // socket.on("popActionToHistory", noFail(function broadcast(msg) {
  //   broadcastHistoryAction(msg, "popActionToHistory",socket)
  // }))

  // socket.on("pushActionToHistoryRedo", noFail(function broadcast(msg) {
  //   broadcastHistoryAction(msg, "pushActionToHistoryRedo",socket)
  // }))

  // socket.on("popActionToHistoryRedo", noFail(function broadcast(msg) {
  //   broadcastHistoryAction(msg, "popActionToHistoryRedo",socket)
  // }))
}
